...
public class Bot extends User{
    ...
    //Creating initially 2 Bots with static parameters for better program testing
    public static void CreateBot(String email, String password, String name){
        ...
        Transaction tr = new Transaction("9087", "04/02/2030", email, cardU.getCardNumber(), "456723455465446", 1000.0);
        Transaction tr1 = new Transaction("9089", "04/02/2031", email, cardE.getCardNumber(), "456754353243467", 300.0);
